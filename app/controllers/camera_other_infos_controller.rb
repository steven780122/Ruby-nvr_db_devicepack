class CameraOtherInfosController < ApplicationController
  def import
    CameraOtherInfo.import(params[:file_camera_others])
    ...
    # if all CameraOtherInfo you import are in CameraInfo's model name, then update all foreign key !!
      ...
      CameraOtherInfo.update_association_foreign_key

      redirect_to import_success_camera_other_infos_path, notice: "Activity Data imported!"
    end
